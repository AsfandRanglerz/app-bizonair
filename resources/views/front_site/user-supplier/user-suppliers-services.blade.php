    ...
    <main id="maincontent" class="product-details suppliers-products">
        ...
        <div class="my-1 p-1 container-lg product-info-container">
            ...
            @if(count($services) > 0)
                                    ...
                                    @foreach($prod->product_image as $j => $image)
                                        ...
                                        <li class="listing" data-thumb="{{$image->image}}" data-src="{{$image->image}}">
                                            <a href="{{ route('productDetail',['category'=>get_category_slug($prod->category_id),'subcategory'=>get_sub_category_slug($prod->subcategory_id),'prod_slug'=>$prod->slug]) }}">
                                                <img class="w-100 border-grey" src="{{$image->image}}" class="img-fluid">
                                            </a>
                                        </li>
                            ...
                            <div class="col-md-6 px-2">
                                <div class="p-2 rounded-8px border-grey">
                                    <div>
                                        ...
                                        <button class="mt-2 mb-md-0 mb-1 p-0 red-btn" @if(!Auth::check()) onclick="location.href='{{ route('log-in-pre') }}'" @else data-toggle="modal" data-target="#contactFormPDP" @endif><span class="d-inline-block py-1 px-2" data-placement="bottom" title="" data-toggle="tooltip" data-original-title="Send an Inquiry to company on Bizonair portal">MESSAGE</span></button>
                                    </div>
                                </div>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="postInquiry" method="POST" action="{{route('post-inquiry')}}">
                                                    ...
                                                    <div id="totalCharLeft">1000 characters remaining</div><textarea id="description" class="mb-4 textarea-box form-control" name="description" placeholder="Describe Your Requirement..." maxlength="1000"></textarea><div class="form-row">
                                                         <div class="form-row">
                ...
                @endforeach
            @else
                <h5 class="font-weight-bold heading">No Services Found</h5>
            @endif
