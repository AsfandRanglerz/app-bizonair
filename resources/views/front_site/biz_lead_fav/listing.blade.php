                        ...
                        <div class="content-box-email mail-reply-box">
                            ...
                            <div class="py-2 px-2 d-flex justify-content-between">
                                <div class="d-flex w-60">
                                    ...
                                    <p class="mb-0 ml-2 click-inbox overflow-text-dots-one-line h-1-5-rm @if( $list->latestMessageNotMine && check_in_my_read($list,$list->latestMessageNotMine->id, 'fav_lead')  ) font-weight-bold @endif"
                                ...
                                <div class="d-flex">
                                    <p class="mb-0 click-inbox @if( $list->latestMessageNotMine && check_in_my_read($list,$list->latestMessageNotMine->id, 'fav_lead')  )  font-weight-bold @endif"
                                       data-click-id="{{$list->id}}">
...
$(document).on('click', '.click-inbox', function(){
            ...
            $.post("{{route('get-lead-fav-messages-inbox')}}", {
                _token: '{{csrf_token()}}',
                conversation_id: id,
                json: 'yes'
            }, function (data) {
