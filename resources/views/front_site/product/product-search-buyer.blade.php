                    ...
                    <div class="row">
                        <div class="col-md-9 p-lg-3 p-0">
                            <div class="d-md-flex text-center justify-content-between align-items-center mb-2">
                                <p class="mb-md-0 mb-1 font-500">{{ strtoupper($subcategory) }} BUYERS <span style="color: #999">({{ $viewCount}} PRODUCTS)</span></p>
                                                ...
                                                <div class="col-6 p-1 border-grey">
                                                    <div>
                                                        ...
                                                        <div class="d-flex column-gap-4">
                                                            <a class="p-0 red-btn"  @if(!Auth::check()) href="{{route('about-us-suppliers',$prod->company_id)}}" @endif data-toggle="modal" data-target="#contactFormPDP"><span class="d-inline-block py-1 px-2" data-placement="bottom" title="Send an Inquiry to company on Bizonair portal" data-toggle="tooltip">MESSAGE</span></a>
