                                        ...
                                        <div class="mt-2 product-box">
                                            <div class="mx-0 row product-content-container">
                                                ...
                                                <div class="w-100 mt-1 d-flex justify-content-between other-product-link-sections">
                                                    <a class="red-link text-decoration-none" @if(!Auth::check()) href="{{url('log-in-pre')}}" @else href="{{route('products-suppliers',$prod->company_id)}}" @endif>Other products from this Supplier</a>
