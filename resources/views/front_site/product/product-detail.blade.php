            ...
            <div class="container-fluid px-2 py-2">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('business-products/fibers-and-materials') }}">Textile
                                Business</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ url('business-products/'.$category->slug) }}">{{ucfirst($category->name)}}</a>
                        </li>
                        <li class="breadcrumb-item"><a
                                href="{{ url('business-products/'.$category->slug.'/'.$sub_category->slug.'/regular-suppliers') }}">{{ucfirst($sub_category->name)}}</a>
                        </li>
                    </ol>
                </nav>
                                    ...
                                    <ul id="left-thumb-slider">
                                        @foreach(ProductHelper::getImages($product->id) as $image)
                                            <li data-thumb="{{$image->image}}"
                                                class="position-relative suppliers-buyers">
                                            <!-- {{asset($image->image)}} -->
                                                <img src="{{$image->image}}"
                                                ...
                                                <div class="position-absolute heart-icon-div">
                                                    <a class="text-decoration-none text-reset"
                                                       href="#add-fav-{{$product->reference_no}}" data-toggle="modal">
                           <span class="text-decoration-none add-to-fav">
                                    <span
                                        class="@if(\DB::table('favourites')->where(['user_id'=>auth()->id(),'reference_no'=>$product->reference_no])->exists()) check-heart fa fa-heart @else check-heart fa fa-heart-o @endif"></span>
                           </span>
                                                    </a>
                                                </div>
                                            </li>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-login">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                @endif
                                                <a class="close red-btn" data-dismiss="modal"
                                                   aria-hidden="true">&times;</a>
                                            </div>
                                            <div class="modal-body pt-3">
                                                @if(\DB::table('favourites')->where(['user_id'=>auth()->id(),'reference_no'=>$product->reference_no])->exists())
                                                    <p style="color: white">Are you sure your product will be removed
                                                        from the favourite</p>
                                                @else
                                                    <p style="color: white">A notification will be sent to
                                                        supplier/buyer to contact you back</p>
                                                @endif
                                                <div class="form-group mt-4 mb-0">
                                                    <button @if(Auth::check()) class="red-btn add-to-favourite"
                                                            data-dismiss="modal" prod_id="{{$product->id}}"
                                                            ...
                                                            @else class="red-btn" data-dismiss="modal"
                                ...
                                <div
                                    class="px-1 d-flex flex-column justify-content-sm-between col-lg-6 col-md-6 mt-md-0 mt-1 contact-product-info">
                                    <span class="product-title heading">{{$product->product_service_name}}</span>
                                    <p><span class="font-500"
                                             style="color: #000">Reference No: </span>{{$product->reference_no}}</p>
                                    <p style="margin-bottom: 4px"><span class="font-500" style="color: #000">Regular Business Lead: </span> {{$product->product_service_types}}
                                    </p>
                                    <p class="product-details">{{$product->details}}</p>
                                    <div class="d-flex justify-content-sm-start justify-content-center btns-block">
                                        <a href="#" class="p-0 btns" @if(!Auth::check()) data-toggle="modal"
                                           data-target="#login-form" @endif data-toggle="modal"
                                           data-target="#contactFormPDP"><span class="red-btn d-inline-block py-1 px-2"
                                        ...
                                        <a href="{{route('contact-us-suppliers',$product->company_id)}}"
                                           class="p-0 btns" @if(!Auth::check()) data-toggle="modal"
                                           data-target="#login-form" @endif><span
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="contactFormPDP" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="alert alert-success mb-2 text-center"
                                                             id='alert-success-inquiry' style="display: none"
                                                             role="alert">
                                                        </div>
                                                        <div class="alert alert-danger mb-2 text-center"
                                                             id='alert-error-inquiry' style="display: none"
                                                             role="alert">
                                                        </div>
                                                        <form id="postInquiry" method="POST"
                                                              action="{{route('post-inquiry')}}">
                                                            @csrf
                                                            <input type="hidden" class="form-control"
                                                                   @if(auth()->check()) value="{{\Auth::id()}}"
                                                                   @endif name="userID">
                                                            <input type="hidden" class="form-control"
                                                                   value="{{$product->id}}" name="prodId">
                                                            <input type="hidden" class="form-control" value="Lead"
                                                                   name="prodType">
                                                            <input type="hidden" class="form-control"
                                                                   value="{{$product->product_service_types}}"
                                                                   name="serviceTypes">
                                                            <input type="hidden" class="form-control"
                                                                   value="{{$product->reference_no}}"
                                                                   name="referenceNo">
                                                            <div class="form-row">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <input type="number" class="form-control"
                                                                           ...
                                                                           @if(auth()->check()) value="{{\Auth::user()->registration_phone_no}}"
                                                                           @endif required="required">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <select name="country" class="form-control"
                                                                        ...
                                                                        @foreach ($countries as $item)
                                                                            <option
                                                                                value="{{$item->name->common}}">{{$item->name->common}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                            ...
                                                            <textarea id="description"
                                                                      class="mb-4 textarea-box form-control"
                                                                      name="description"
                                                                      placeholder="Describe Your Requirement..."
                                                                      maxlength="1000"></textarea>
                                                            <div class="form-row">
                                                                <div
                                                                    class="form-group col-md-12 career-img-drop-outer attachment-img-file">
                                                                    <label
                                                                        class="d-block text-left text-white mb-2 font-500">Attachment
                                                                        <small class="font-500">(Attach Reference or
                                                                            Image)</small></label>
                                                                    <div class="custom-file">
                                                                        ...
                                                                        <label class="custom-file-label"
                                                                               for="customFile"><span
                                                                                class="fa fa-download"></span></label>
                                                                        <small class="text-danger"
                                                                               id="image_error"></small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div
                                                                    class="form-group ticks-checkbox col-md-12 mt-0 mb-0">
                                                                    <ul data-toggle="buttons" class="mb-0">
                                                                        <li class="btn">
                                                                            <input class="input fa fa-square-o"
                                                                                   type="checkbox"
                                                                                   id="sample_with_specification_sheet"
                                                                                   name="sample_with_specification_sheet"
                                                                                   value="Sample with specification sheet">Sample
                                                                            with specification sheet
                                                                        </li>
                                                                        <li class="btn">
                                                                            <input class="input fa fa-square-o"
                                                                                   type="checkbox"
                                                                                   id="latest_price_quotation"
                                                                                   name="latest_price_quotation"
                                                                                   value="Latest Price Quotation">Latest
                                                                            Price Quotation
                                                                        </li>
                                                                        <li class="btn">
                                                                            <input class="input fa fa-square-o"
                                                                                   type="checkbox"
                                                                                   id="compliance_certification_required"
                                                                                   name="compliance_certification_required"
                                                                                   value="Compliance certification required">Compliance
                                                                    ...
                                                                    <ul data-toggle="buttons" class="mb-0">
                                                                        <li class="btn">
                                                                            <input class="input fa fa-square-o"
                                                                                   ...
                                                                                   value="Preferred payment terms">Preferred
                                                                            payment terms
                                                                        </li>
                                                                        <li class="btn">
                                                                            <input class="input fa fa-square-o"
                                                                                   ...
                                                                                   value="Production Capacity">Production
                                                                            Capacity
                                                                        </li>
                                                                        <li class="btn">
                                                                            <input class="input fa fa-square-o"
                                                                                   type="checkbox" id="qcis" name="qcis"
                                                                                   value="I am looking for Quality, Consultation & Inspection Services from Bizonair Team">I
                                                                            am looking for Quality, Consultation &
                                                                            Inspection Services from Bizonair Team
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group ticks-checkbox mt-3 mb-3">
                                                                <ul data-toggle="buttons" class="mb-0">
                                                                    <li class="w-100 btn d-flex">
                                                                        ...
                                                                        <div>Please refer our <a
                                                                                href="{{route('privacy-policy')}}"
                                                                                target="_blank" class="text-link">Privacy
                                                                                Policy</a> and <a
                                                                                href="{{route('terms-of-use')}}"
                                                                                target="_blank" class="text-link">Terms
                                                                                & Conditions</a> before submitting your
                                                                            information
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                    ...
                                    <p class="my-1"><span class="font-500" style="color: #000">Note :</span> By clicking
                                        favourite, a notification will be sent to the Supplier/Buyer</p>
                                </div>
                            </div>
                        </div>
                            ...
                            @if(auth()->user())
                                <div class="supplier-info">
                                    <div class="position-relative">
                                        ...
                                        <div class="d-flex membersince">Member <span class="number">since</span><span
                                                class="years">{{get_product_created_at($product->company_id)}}</span>
                                        </div>
                                        <div class="position-absolute top-0 right-0 membericon">
                                            <a href="http://localhost/bizonair-database/404">
                                                <img alt="Premium Member"
                                                     src="{{$ASSETS}}/assets/front_site/images/leads-membership.png"
                                                     title="We are working on this feature and will enable this soon"
                                                     data-toggle="tooltip" data-placement="bottom" data-toggle="tooltip"
                                                     data-placement="bottom" style="width: 30px;height: 30px">
                                            </a>
                                        </div>
                                    </div>
                                    <small class="overflow-text-dots-one-line"><span
                                            class="font-500">Supplier Name: </span><span> <a
                                                href="{{route('about-us-suppliers',$product->company_id)}}"
                                                class="text-reset"> {{get_product_company($product->company_id)}}</a></span></small>
                                    <small class="d-block grey-text font-500">{{get_product_city($product->company_id)}}
                                    ...
                                    <p class="add-connect"><span class="fa fa-address-book" aria-hidden="true"></span><a
                                            ...
                                            title="We are working on this feature and will enable this soon"
                                            data-toggle="tooltip" data-placement="bottom">Add To My Connection</a></p>
                                    <div id="add-connection" class="change-password-modal modal fade">
                                        <div class="modal-dialog modal-dialog-centered modal-login">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body pt-3">
                                                    <p style="color: white">we are working on this feature and we will
                                                        enable this soon..</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="supplier-info">
                                    <div class="login-info">
                                        ...
                                        <div class="login-info-inner">
                                            <p><a href="" data-toggle="modal" data-target="#login-form"
                                                  class="font-500 register-text">Log in</a> To View More Information.
                                                <span class="font-500" style="color: #000">Not a member? </span><a
                                                    href="{{route('email-confirmation')}}" target="_blank"
                                    ...
                                    <div id="productInfo" class="tab-pane product-tab active">
                                        <div class="row text mx-0">
                                            ...
                                            <div class="col-xl-9 col-lg-8 col-sm-6 col-6 pl-1 pr-0">
                                                <p class="mb-0">@if($product->product_service_types == 'Service')Service
                                                    Provider @else {{ $product->product_service_types }} @endif</p>
                                            </div>
                                        </div>
                                        <div class="row text mx-0">
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-6 pl-0 pr-1">
                                        ...
                                        @if(!empty($product->fabric_product_info->fabric_types))
                                            ...
                                            <div class="row text mx-0">
                                                ...
                                                <div class="col-xl-9 col-lg-8 col-sm-6 col-6 pl-1 pr-0">
                                                    <p class="mb-0">{{$product->fabric_product_info->width_from ?: ''}}
                                                        To {{$product->fabric_product_info->width_to ?: ''}}</p>
                                                </div>
                                            </div>
                                            <div class="row text mx-0">
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-6 pl-0 pr-1">
                                        ...
                                        @if($product->is_sampling)
                                            <div class="row text mx-0">
                                                ...
                                                <div class="col-xl-9 col-lg-8 col-sm-6 col-6 pl-1 pr-0">
                                                    <p class="mb-0">@if($product->is_sampling)
                                                            Yes @elseif(!$product->is_sampling) No @endif</p>
                                                </div>
                                            </div>
                                        @endif
                                        @if($product->is_sampling)
                                                                ...
                                                                <div class="include-in-gallery"
                                                                    ...
                                                                    <a href="">
                                                                        ...
                                                                        <div class="demo-gallery-poster">
                                                                            <img
                                                                                src="https://sachinchoolur.github.io/lightGallery/static/img/zoom.png">
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                            </li>
                                            ...
                                            @if($prod->product_image->isNotEmpty())
                                                @foreach($prod->product_image as $j => $image)
                                                    ...
                                                    @if($prod->is_featured ==1)
                                                        <span
                                                            class="position-absolute left-0 Featured-txt">Featured</span>
                                                    @endif
                                                @endforeach
                                            @else
                                                <img src="{{$ASSET}}/front_site/images/noimage.png"
