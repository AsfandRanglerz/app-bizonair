                  ...
                  <div class="col-xl-9 col-lg-12">
                      <div class="row">
                          ...
                          <div class="col-lg-6 col-md-6 mt-sm-0 mt-3 contact-product-info">
                              ...
                              <p style="margin-bottom: 15px"><span class="font-500" style="color: #000">Regular Business Lead: </span> @if($product->product_service_types =='Service') Service Provider @endif</p>
                  ...
                  <div class="col-xl-9 col-lg-8 col-md-8">
                      ...
                      <div class="switch-tabs" id="productInfoSection">
                          ...
                          <ul class="nav nav-tabs">
                              <li class="nav-item">
                                  <a class="nav-link active" data-toggle="tab" href="#productInfo">SERVICE INFO</a>
                              </li>
                              <li class="nav-item">
                              ...
                              <div id="productInfo" class="tab-pane product-tab active">
                                  ...
                                  <div class="row text">
                                      ...
                                      <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                          <p class="mb-sm-0">{{ $product->category->name }}</p>
                                      </div>
                                  </div>
                                  <div class="row text">
                                      <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                  ...
                                  <div class="row text">
                                      ...
                                      <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                          @if ($product->details)
                                              <p class="mb-sm-0">{{ $product->details }}</p>
                                          @else
                                              <p class="mb-sm-0">-</p>
                                          @endif
                                      </div>
                                  ...
                                  @if($product->product_service_types == "Service")
                                      ...
                                      <div class="row text">
                                          ...
                                          <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                              <p class="mb-sm-0">{{ str_replace(',', ', ', $product->service_durations) }}</p>
                                          </div>
                                      </div>
                                      ...
                                      @if(in_array("Other", explode(",", $product->service_durations)))
                                          <div class="row text">
                                              ...
                                              <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                                  <p class="mb-sm-0">{{ $product->other_service_duration }}</p>
                                              </div>
                                          </div>
                                      @endif
                                  @else
                                      @if($product->delivery)
                                          <div class="row text">
                                              ...
                                              <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                                  <p class="mb-sm-0">{{ $product->delivery }}</p>
                                              </div>
                                          </div>
                                      @endif
                                      @if($product->delivery_time)
                                          <div class="row text">
                                              ...
                                              <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                                  <p class="mb-sm-0">{{ $product->delivery_time }}</p>
                                              </div>
                                          </div>
                                      @endif
                                  @endif
                                  @if(in_array("Other", explode(",", $product->suitable_currencies)))
                                      <div class="row text">
                                          ...
                                          <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                              <p class="mb-sm-0">{{ $product->other_suitable_currency }}</p>
                                          </div>
                                      </div>
                                  @else
                                      <div class="row text">
                                          ...
                                          <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                              <p class="mb-sm-0">{{$product->suitable_currencies }}</p>
                                          </div>
                                      </div>
                                  @endif
                                  ...
                                  @if(in_array("Other", explode(",", $product->payment_terms)))
                                      <div class="row text">
                                          ...
                                          <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                              <p class="mb-sm-0">{{ $product->other_payment_term }}</p>
                                          </div>
                                      </div>
                                  @else
                                      <div class="row text">
                                          ...
                                          <div class="col-xl-9 col-lg-8 col-sm-6 col-6">
                                              <p class="mb-sm-0">{{ str_replace(',', ', ', $product->payment_terms) }}</p>
                                          </div>
                                      </div>
                                  @endif
                              </div>
