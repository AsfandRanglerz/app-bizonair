...
{{--                                                </div>--}}
                                                <div class="d-sm-inline-block my-1">
                                                    <a href=""  class="pt-1 pb-1 pl-2 pr-2 red-btn" @if(Auth::check()) data-toggle="modal" data-target="#contactFormPDP" @else data-toggle="modal" data-target="#login-form" @endif >CONTACT</a>
                                                    <!-- Modal -->
