                                        ...
                                        <div class="mt-2 product-box">
                                            <div class="mx-0 mt-3 row product-content-container">
                                                ...
                                                <div class="col-xl-5 col-lg-5 p-lg-2 p-0  product-details"><p class="mb-1 title font-weight-bold overflow-text-dots-subject">{{$prod->product_service_name}}</p>
                                                    ...
                                                    <p class="my-1 text-uppercase place-day">{{ get_buysell_city($prod->user_id) }}, {{$prod->origin}} <span class="ml-3">{{\Carbon\Carbon::parse($prod->creation_date)->diffForHumans()}}</span></p>
                                                </div>
                                                <div class="col-xl-4 col-lg-6 p-lg-2 p-0 ">
                                                    ...
                                                    <p class="mb-1 text-uppercase font-500 font-24">{{get_buysell_user_name($prod->user_id)}}</p>
                                                    <p class="mb-0 text-uppercase">{{ get_buysell_city($prod->user_id) }}, {{get_buysell_country($prod->user_id)}} </p>
                                                    <p>CONTACT : {{ get_buysell_contact_no($prod->user_id) }}</p>
