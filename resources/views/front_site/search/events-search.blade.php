...
{{--        </div>--}}
        <div class="suppliers-buyers">
            <div class="container-fluid">
                <div class="my-3 font-500 searh-status">Search Criteria : <span class="grey-text">Search Name - </span>{{ $search }}, <span class="grey-text">Lead Type - </span>{{ $category }} <span class="grey-text">({{count($articles)}} EVENTS)</span></div>
