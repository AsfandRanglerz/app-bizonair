                ...
                <div class="row mx-0 mb-4 search-main-container">
                    <div class="col-md-12 p-3">
                        <div class="d-flex flex-wrap justify-content-around link-heading-container">
                            ...
                            <h6 class="position-relative link-heading active-heading"><a href="{{Request::fullUrl()}}" class="text-reset text-decoration-none">ONE-TIME DEALS ({{getOneTimeSupplier(request()->keywords)+getOneTimeBuyer(request()->keywords)}})</a></h6>
                        ...
                        <div class="mt-3 product-main-container">
                            <ul class="ml-1 mr-1 nav nav-tabs">
                                <li class="active list">
                                    <a href="{{Request::fullUrl()}}" class="text-uppercase link">ONE-TIME SELLING ({{count($buysell)}})</a>
                                </li>
                                <li class="list">
                                    <a href="{{url('search-product?category=One-Time+Buyer&keywords='.request()->keywords)}}" class="text-uppercase link">ONE-TIME BUYING ({{getOneTimeBuyer(request()->keywords)}})</a>
                                </li>
                            </ul>
