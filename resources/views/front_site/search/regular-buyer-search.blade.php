                ...
                <div class="row mx-0 mb-4 search-main-container">
                    <div class="col-md-12 p-3">
                        <div class="d-flex flex-wrap justify-content-around link-heading-container">
                            <h6 class="position-relative link-heading active-heading"><a href="{{url('search-product?category=Regular+Supplier&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">MYBIZ LEADS ({{getRegularSupplier(request()->keywords)+getRegularBuyer(request()->keywords)}})</a></h6>
                        ...
                        <div class="mt-3 product-main-container">
                            <ul class="ml-1 mr-1 nav nav-tabs">
                                <li class="list">
                                    <a href="{{url('search-product?category=Regular+Supplier&keywords='.request()->keywords)}}" class="text-uppercase link">REGULAR SUPPLIERS  ({{getRegularSupplier(request()->keywords)}})</a>
                                </li>

                                <li class="active list">
                                    <a href="{{Request::fullUrl()}}" class="text-uppercase link">REGULAR BUYERS ({{count($products)}})</a>
                                </li>
                            </ul>
