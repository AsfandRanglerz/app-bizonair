...
{{--        </div>--}}
        ...
        <div class="suppliers-buyers">
            <div class="container-fluid px-2 py-2">
                <div class="mb-2 font-500 searh-status">Search Criteria : <span class="grey-text">Search Name - </span>{{ $search }}, <span class="grey-text">Type - </span>{{ $category }} <span class="grey-text">({{count($products)}} PRODUCTS)</span></div>
