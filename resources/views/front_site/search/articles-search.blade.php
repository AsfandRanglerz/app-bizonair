...
{{--        </div>--}}
        <div class="suppliers-buyers">
            <div class="container-fluid px-2 py-2">
                <div class="mb-2 font-500 searh-status">Search Criteria : <span class="grey-text">Search Name - </span>{{ $search }}, <span class="grey-text">Type - </span>{{ $category }} <span class="grey-text">({{count($articles)}} ARTICLES)</span></div>
                <div class="row mx-0 mb-4 search-main-container">
                    <div class="col-md-12 p-2">
                        <div class="d-flex flex-wrap justify-content-around link-heading-container">
                            ...
                            <h6 class="position-relative link-heading active-heading"><a href="{{url('search-product?category=articles&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">ARTICLES ({{getArticles(request()->keywords)}})</a></h6>
                                        ...
                                        <div class="product-box col-lg-3 col-6 my-1 px-1 textile-box">
                                            <a href="{{route('journal-detail',['type'=>$article->journal_type_name,'id'=>$article->id])}}" class="text-decoration-none">
                                                ...
                                                <div class="mb-0 textile-caption">
                                                    <span class="overflow-text-dots-one-line">{{$article->journal_type_name}} | {{date("d-F-Y", strtotime($article->publish_date))}}</span>
