    ...
    <main id="maincontent" class="page-main">
        ...
        <div class="suppliers-buyers">
            <div class="container-fluid">
                <div class="my-3 font-500 searh-status">Search Criteria : <span class="grey-text">Search Name - </span>{{ $search }}, <span class="grey-text">Lead Type - </span>{{ $category }} <span class="grey-text">({{count($products)}} PRODUCTS)</span></div>
                <div class="row mx-0 mb-4 search-main-container">
                    <div class="col-md-12 p-3">
                        <div class="d-flex flex-wrap justify-content-around link-heading-container">
                            <h6 class="position-relative link-heading"><a href="{{url('search-product?category=Regular+Supplier&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">MYBIZ LEADS ({{getRegularSupplier(request()->keywords)+getRegularBuyer(request()->keywords)}})</a></h4>&nbsp;&nbsp;
                            <h6 class="position-relative link-heading"><a href="{{url('search-product?category=One-Time+Supplier&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">ONE-TIME DEALS ({{getOneTimeSupplier(request()->keywords)+getOneTimeBuyer(request()->keywords)}})</a></h4>&nbsp;&nbsp;
                            <h6 class="position-relative link-heading active-heading"><a href="{{Request::fullUrl()}}" class="text-reset text-decoration-none">SERVICES ({{getServiceProviders(request()->keywords)+getServiceSeekers(request()->keywords)}})</a></u></h4>&nbsp;&nbsp;
                            <h6 class="position-relative link-heading"><a href="{{url('search-product?category=Companies&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">COMPANIES ({{getSearchCompanies(request()->keywords)}})</a></h4>&nbsp;&nbsp;
                            <h6 class="position-relative link-heading"><a href="{{url('search-product?category=articles&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">ARTICLES ({{getArticles(request()->keywords)}})</a></h4>&nbsp;&nbsp;
                            <h6 class="position-relative link-heading"><a href="{{url('search-product?category=news&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">NEWS ({{getNews(request()->keywords)}})</a></h4>&nbsp;&nbsp;
                            <h6 class="position-relative link-heading"><a href="{{url('search-product?category=events&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">EVENTS ({{getEvents(request()->keywords)}})</a></h4>
                        </div>
                        <div class="mt-3 product-main-container">
                            <ul class="ml-1 mr-1 nav nav-tabs">
                                <li class="active list">
                                    <a href="{{Request::fullUrl()}}" class="text-uppercase link">SERVICE PROVIDERS  ({{count($products)}})</a>
                                </li>
                                <li class="list">
                                    <a href="{{url('search-product?category=One-Time+Services&keywords='.request()->keywords)}}" class="text-uppercase link">SERVICE SEEKERS ({{getServiceSeekers(request()->keywords)}})</a>
                                </li>
                            </ul>
                                                                ...
                                                                <div class="modal-dialog contact-form" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="alert alert-success mb-2 text-center" id='alert-success-inquiryy' style="display: none"
                                                                                 role="alert">
                                                                            </div>
                                                                            <div class="alert alert-danger mb-2 text-center" id='alert-error-inquiryy' style="display: none"
                                                                                 role="alert">
                                                                            </div>
                                                                            <form id="mainSearchProductinquiry" method="POST" action="{{route('post-inquiry')}}">
                                                                                @csrf
                                                                                ...
                                                                                <div class="form-row">
                                                                                    <div class="form-group col-md-6">
                                                                                        <select name="country" class="form-control" id="countryp" required="required">
                                                                                    ...
                                                                                    <div class="form-group col-md-6">
                                                                                        <select name="city" id="citydw" required class="form-control">
                                                                                ...
                                                                                <input type="submit" class="btn submit-btn" id="inquiry_create_btnn" value="Send Inquiry Now">
