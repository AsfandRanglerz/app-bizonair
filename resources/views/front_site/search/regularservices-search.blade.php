                ...
                <div class="row mx-0 mb-4 search-main-container">
                    <div class="col-md-12 p-2">
                        <div class="d-flex flex-wrap justify-content-around link-heading-container">
                            ...
                            <h6 class="position-relative link-heading active-heading"><a href="{{Request::fullUrl()}}" class="text-reset text-decoration-none">SERVICES ({{getServiceProviders(request()->keywords)+getServiceSeekers(request()->keywords)}})</a></u></h6>
