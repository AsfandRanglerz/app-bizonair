                ...
                <div class="row mx-0 mb-4 search-main-container">
                    <div class="col-md-12 p-2">
                        <div class="d-flex flex-wrap justify-content-around link-heading-container">
                            ...
                            <h6 class="position-relative link-heading active-heading"><a href="{{url('search-product?category=Regular+Services&keywords='.request()->keywords)}}" class="text-reset text-decoration-none">SERVICES ({{getServiceProviders(request()->keywords)+getServiceSeekers(request()->keywords)}})</a></h6>
                        ...
                        <div class="mt-2 product-main-container">
                            <ul class="ml-1 mr-1 nav nav-tabs">
                                ...
                                <li class="active list">
                                    <a href="{{Request::fullUrl()}}" class="text-uppercase link">SERVICE SEEKERS ({{count($buysell)}})</a>
                                </li>
                            </ul>
