              ...
              @include('front_site.common.garments-nav')
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('business-products/'.$category->slug.'/'.$sub_category->slug.'/regular-suppliers') }}">{{ucfirst($sub_category->name)}}</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-9 p-lg-3 p-0">
                            <div class="d-md-flex text-center justify-content-between align-items-center mb-3">
                                <p class="mb-md-0 mb-2 font-500">{{ strtoupper($childsubcategory->name) }} > REGULAR SUPPLIERS <span style="color: #999">({{ $viewCount}} PRODUCTS)</span></p>
                            ...
                            <div class="row m-0 search-container">
                                <div class="col-md-8 p-1 text-md-left text-center">
                                    ...
                                    <div class="cities-btn">
                                        ...
                                        <a href="{{route('productsup-search',['category'=>$category->slug,'subcategory'=>$subcategory,'childsubcategory'=>$childsubcategory->slug,'city'=>$prod_city->city])}}" target="_blank" class="mb-2 link">{{$prod_city->city}}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-md-4 p-1 d-flex align-items-end">
                                    <form class="mb-2 w-100 d-flex" action="{{route('productsup-search',['category'=>$category->slug,'subcategory'=>$subcategory,'childsubcategory'=>$childsubcategory->slug])}}" method="get">
                            ...
                            <div class="mt-4 compare-container">
                                <div class="mb-2 compare-cancel-btns">
                                    <a href="{{route('products-compare',['category'=>$category])}}" class="pt-1 pb-1 pl-2 pr-2 red-btn" id="compa" com_cnt="{{ count($comp) }}" type="button">Compare</a>
                                    <a class="pt-1 pb-1 pl-2 pr-2 red-btn cancel-btn" id="cancel" type="button">Cancel</a>
                                </div>
                            </div>
                ...
                {{--                                        </div>--}}
                              ...
                              <button type="submit" disabled class="btn submit-btn btn-proo d-none">
                                   <span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>Send Inquiry Now
                                                ...
                                                <div class="w-100 mt-3 d-flex flex-lg-row flex-column justify-content-lg-center align-items-center other-product-link-sections">
