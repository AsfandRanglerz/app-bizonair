                    ...
                    <div class="row">
                        <div class="col-md-9 p-lg-3 p-0">
                            <div class="d-md-flex text-center justify-content-between align-items-center mb-3">
                                <p class="mb-md-0 mb-2 font-500">{{ strtoupper($childsubcategory->name) }} > ONE-TIME SELLERS <span style="color: #999">({{ $viewCount}} PRODUCTS)</span></p>
                                ...
                                <div class="col-md-8 p-1 text-md-left text-center">
                                    ...
                                    <div class="cities-btn">
                                        @foreach($prod_city_search as $prod_city)
                                            <a href="{{route('search-otsup',['category'=>$category->slug,'subcategory'=>$subcategory,'childsubcategory'=>$childsubcategory->slug,'city'=>$prod_city->city])}}" target="_blank" class="mb-2 link">{{$prod_city->city}}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-md-4 p-1 d-flex align-items-end">
                                    <form class="mb-2 w-100 d-flex" action="{{route('search-otsup',['category'=>$category->slug,'subcategory'=>$subcategory,'childsubcategory'=>$childsubcategory->slug])}}" method="get">
                                            ...
                                            <div class="ml-1 mr-1 mt-3 row product-content-container">
                                                ...
                                                <div class="col-xl-4 col-lg-6 p-3 d-flex justify-content-center border-grey">
                                                    <div>
                                                        ...
                                                        <p class="text-uppercase font-500 font-24">{{get_buysell_user_name($prod->user_id)}}</p>
