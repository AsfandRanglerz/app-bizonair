                                ...
                                <div class="col-md-8 p-1 text-md-left text-center">
                                    ...
                                    <div class="cities-btn">
                                        @foreach($prod_city_search as $prod_city)
                                            <a href="{{route('search-otsup',['category'=>$category->slug,'subcategory'=>$subcategory,'city'=>$prod_city->city])}}" target="_blank" class="mb-2 link">{{$prod_city->city}}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-md-4 p-1 d-flex align-items-end">
                                    <form class="mb-2 w-100 d-flex" action="{{route('search-otsup',['category'=>$category->slug,'subcategory'=>$subcategory])}}" method="get">
