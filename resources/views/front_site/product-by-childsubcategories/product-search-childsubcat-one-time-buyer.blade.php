                                ...
                                <div class="col-md-8 p-1 text-md-left text-center">
                                    ...
                                    <div class="cities-btn">
                                        @foreach($prod_city_search as $prod_city)
                                            <a href="{{route('search-otbuy',['category'=>$category->slug,'subcategory'=>$subcategory,'city'=>$prod_city->city])}}" target="_blank" class="mb-2 link">{{$prod_city->city}}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-md-4 p-1 d-flex align-items-end">
                                    <form class="mb-2 w-100 d-flex" action="{{route('search-otbuy',['category'=>$category->slug,'subcategory'=>$subcategory])}}" method="get">
                            ...
                            <div class="mt-4 product-main-container">
                              ...
                              <button type="submit" disabled class="btn submit-btn btn-proo d-none">
                                   <span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>Send Inquiry Now
                                                ...
                                                {{--                                        <a href="#" class="text-decoration-none red-link">Other products from this--}}
                                                {{--                                            Buyer</a>--}}
                                                {{--                                    </div>--}}
                                            </div>
                                        </div>
