                    ...
                    <div class="row">
                        <div class="col-md-9 p-lg-3 p-0">
                            <div class="d-md-flex text-center justify-content-between align-items-center mb-2">
                                <p class="mb-md-0 mb-1 font-500">{{ strtoupper(str_replace('-', ' ', $subcategory)) }} > REGULAR BUYERS <span style="color: #999">({{ $viewCount}} PRODUCTS)</span></p>
                                @if(!Auth::check())
                                ...
                                <div class="col-md-8 p-1 text-md-left text-center">
                                    ...
                                    <div class="cities-btn">
                                        @foreach($prod_city_search as $prod_city)
                                            <a href="{{route('prod-search-buyer',['category'=>$category->slug,'subcategory'=>$subcategory,'city'=>$prod_city->city])}}"  class="mb-2 link">{{$prod_city->city}}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-md-12 p-1 d-flex align-items-end">
                                    <form class="w-100 d-flex" action="{{route('prod-search-buyer',['category'=>$category->slug,'subcategory'=>$subcategory])}}" method="get">
                            ...
                            <div class="mt-2 product-main-container">
                                <ul class="ml-1 mr-1 nav nav-tabs">
                                    <li class="list">
                                        <a href="{{route('suppliers-subcategory-products',['category'=>$category->slug,'subcategory'=>$subcategory])}}" class="text-uppercase link">REGULAR SUPPLIERS</a>
                                    </li>

                                    <li class="active list">
                                        <a href="{{route('buyers-subcategory-products',['category'=>$category->slug,'subcategory'=>$subcategory])}}" class="text-uppercase link">REGULAR BUYERS</a>
                                    </li>

                                    <li class="list">
                                        <a href="{{route('one-time-seller',['category'=>$category->slug,'subcategory'=>$subcategory])}}" class="text-uppercase link">ONE-TIME SELLERS</a>
                                    </li>

                                    <li class="list">
                                        <a href="{{route('one-time-buyer',['category'=>$category->slug,'subcategory'=>$subcategory])}}" class="text-uppercase link">ONE-TIME BUYERS</a>
                                    </li>
                                                ...
                                                <div class="col-lg-6 p-2 border-grey">
                                                    <div>
                                                        ...
                                                        <div class="d-flex column-gap-4">
                                                            ...
                                                            <a class="p-0 red-btn"  @if(!Auth::check()) href="{{url('log-in-pre')}}" @else href="{{route('contact-us-suppliers',$prod->company_id)}}" @endif><span class="d-inline-block py-1 px-2" data-placement="bottom" title="Send an Email to company" data-toggle="tooltip">CONTACT US</span></a>
                                                            <!-- Modal -->
...
{{--                            {{ $products->links() }}--}}
                        ...
                        <div class="px-0 h-auto col-xl-2 col-lg-3 col-md-4 half-side-content">
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $(document).delegate('.cross-icon', 'click', function(e) {
            e.preventDefault();
