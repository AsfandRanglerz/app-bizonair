                ...
                <div class="mx-2 my-2">
                    <div id="companyTab1">
                        <div class="tab-content" id="myCompanyTab">
                            <div class="px-0 py-2 tab-pane fade show active" id="tabProfile" role="tabpanel"
                                ...
                                <div class="p-3 tab-pane fade payment-info-tab" id="tabInfo" role="tabpanel"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-lg-6 add-services-duration other-div"
                                            ...
                                            <label class="font-500">Add Your Service Duration <span class="required">*</span></label>
