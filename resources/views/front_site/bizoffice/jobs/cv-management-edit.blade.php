                            ...
                            <form id="updateCvForm" name="updateCvForm" method="POST" action="{{route('update-view-cv-management')}}">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number"
                                               name="total_experience" id="total_experience" value="{{ $info->total_experience }}" class="form-control"
                                               required>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control"
                                            ...
                                            <option value="Audit" @if($info->functional_area == "Audit") selected @endif>Audit</option>
