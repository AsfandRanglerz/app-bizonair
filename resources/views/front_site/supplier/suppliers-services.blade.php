...
@section('content')
    ...
    <main id="maincontent" class="product-details suppliers-products">
        ...
        <div class="my-2 container-lg product-info-container">
                ...
                @foreach($services as $i => $prod)
                    <div class="product-info">
                        ...
                        <div class="col-md-6">
                            ...
                            <button class="mt-5 red-btn" @if(!Auth::check()) data-toggle="modal" data-target="#login-form" @endif data-toggle="modal" data-target="#contactFormPDP">SEND A MESSAGE</button>
                            <!-- Modal -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id="postInquiry" method="POST" action="{{route('post-inquiry')}}">
                                                ...
                                                <input type="hidden" class="form-control" value="Service" name="prodType">
