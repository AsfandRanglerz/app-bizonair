                    ...
                    <div class="mb-3 about-us-section">
                        <div class="mb-2 d-flex flex-wrap flex-md-row flex-column justify-content-between align-items-center">
                            ...
                            <div class="d-flex flex-wrap column-gap-4">
                                <input type="text" class="d-none" name="link" id="sharlink" value="https://www.bizonair.com/{{$about_us->id}}/{{$about_us->company_name}}/about-us-suppliers">
                                <a id="linkSharebtn"  class="red-btn">Copy URL </a>
                        ...
                        <p class="mb-0">{!! $about_us->company_introduction !!}</p>
                    </div>
                </div>
            </div>
...
@push('js')
    <script type="text/javascript">
        /*copy url*/
        $(document).on("click", "#linkSharebtn", function (e) {
            $("body").append('<input id="copyURL" type="text" value="" />');
            var frontSideUrl = $('#sharlink').val();
            $("#copyURL").val(frontSideUrl).select();
