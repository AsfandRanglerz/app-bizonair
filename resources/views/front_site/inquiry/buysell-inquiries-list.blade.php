                ...
                <div class="  d-container mt-2">
                    <div class="">
                        ...
                        @if($request->case && $request->case == 'archive')
                            <div class="my-3">
                                <a href="{{ route('buysell-inquiries') }}" class="blue-btn">Active Products Inquiries</a>
                            </div>
                        @else
                            <div class="my-3">
                                <a href="{{ route('buysell-inquiries') }}?case=archive" class="blue-btn">Archived
                    ...
                    <div class="table-responsive table-mt mt-3">
                        ...
                        <table class="table table-bordered table-striped datatableSearch">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <ul class="dropdown-menu actionMenu p-10" role="menu">
                                            ...
                                            @if($request->case && $request->case == 'archive')
                                                <a href="javascript:;" class="restore-prod-inquiry" onclick="return false;">
                                                    <li class="font-500">
                                                        <span class="fa fa-undo delete-btn mr-3"
                                                              aria-hidden="true"></span>Restore
                                                    </li>
                                                </a>
                                                <a href="javascript:;" class="delete-prod-inquiry" onclick="return false;">
                                                    <li class="font-500">
                            ...
                            @else
                                <tr>
                                    <td>{{ ($request->case && $request->case == 'archive') ? 'No Buysell Inquiry in archive' : 'No Buysell Inquiry added yet' }}</td>
                                </tr>
                            @endif
...
@push('js')
    ...
    <script>
        ...
        $(document).on('click', '.restore-prod-inquiry', function () {
            ...
            swal({
                title: "Are you sure?",
                text: "Buy Sell Inquiries will be visible on the website.",
                icon: "warning",
