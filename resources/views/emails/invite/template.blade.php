...
<div>
    ...
    <p style="margin-bottom: 16px">Please use this verification code {{$invite->verification_code}} while doing registration process or if you're a registered member then just swipe your sidebar or drawer and click the link as shown in attached Image below, on clicking that link OTP Screen will appear where you can add the OTP.</p>
