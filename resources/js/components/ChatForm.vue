<template>
    ...
    <div class="d-none justify-content-between p-3 quote-box">
        <p class="mb-0 font-italic overflow-text-dots-one-line">  </p>
...
<script>
export default {
    props: ['company_id', 'user', 'show_chat','quote_msg_id','quote_msg_txt'],
    ...
    methods: {
        sendMessage() {
            ...
            console.log('check quote msg again ', this.quote_msg_id+' '+this.show_chat);
