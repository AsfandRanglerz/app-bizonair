...
(function ($) {
    ...
    $.fn.uploader = function (options, testMode) {
        ...
        return this.each(function (index) {
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $('<button class="js-uploader__submit-button d-none uploader__submit-button uploader__hide">' +
            ...
            function addItem (file) {
                ...
                if (options.fileTypeWhiteList.indexOf(getExtension(file.name).toLowerCase()) !== -1) {
                    ...
                    $('#companyForm').append('<input type="hidden" value="'+state.fileBatch+'" multiple name="company_images[]">')
