                            ...
                            <div class="tab-content" id="myCompanyTab">
                                <div class="px-0 py-2 tab-pane fade show active" id="tabReg" role="tabpanel"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 product-name">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 product-availability">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="product_images" class="font-500">Product Images <span class="required"> *</span><br><small class="font-500">(JPG & PNG  files only | Atleast one product image | Upto
                                                    10MB)</small></label>
                                    ...
                                    <div class="additional-product-info knitted-fabric-info" style="display: none;">
                                        <span class="d-block mb-3 heading">Product Specifications</span>
                                        <div class="form-row">
                                            <div class="form-group col-md-6 fabric-type">
                                            ...
                                            <div class="form-group col-md-6 other-div">
                                                <label class="font-500">Other Knitted Fabric Type <span class="required"> *</span></label>
                                                <input type="text" name="other_knitted_fabric_type" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6 weave-type">
                                            ...
                                            <div class="form-group col-md-6 other-div">
                                                <label class="font-500">Other Knitted Knitting Type <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 other-div">
                                                <label class="font-500">Other Knitted Manufacturing Technique <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 other-div">
                                                <label class="font-500">Other Knitted Yarn Type <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 add-knitted-features-field other-div">
                                                <label class="font-500">Other Knitted Feature <span
                                                        class="required">*</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 add-knitted-Use-field">
                                                <label class="font-500">Other Knitted End Use Application <span
                                                        class="required">*</span></label>
                                    ...
                                    <div class="additional-product-info fabric-info" style="display: none;">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group weaving-checkbox col-lg-6">
                                                ...
                                                <div class="">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" class="custom-control-input radio-btn"
                                                               value="Hand Loom" id="wovenHandLoom" name="woven_manufact"
                                                               required>
                                                        <label class="custom-control-label" for="wovenHandLoom">Hand
                                                            Loom</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" class="custom-control-input radio-btn"
                                            ...
                                            <div class="form-group col-md-6 other-div" id="addWovenOtherWeaving">
                                                <label class="font-500">Other Woven Manufacturing Technique<span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 other-div" id="otherWovenWeaving">
                                                <label class="font-500">Other Woven Yarn Type <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 add-features-field">
                                                <label class="font-500">Other Woven Feature <span
                                                        class="required">*</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 add-Use-field">
                                                <label class="font-500">Other Woven Use <span
                                                        class="required">*</span></label>
                                    ...
                                    <div class="additional-product-info non-woven-fabric-info" style="display: none;">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 other-div add-fabric-type">
                                                <label class="font-500">Other Non Woven Fabric Type <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 other-div add-fabric-type">
                                                <label class="font-500">Other Non Woven Type <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 other-div" id="addNonWovenOtherWeaving">
                                                <label class="font-500">Other Non Woven Manufacturing Technique <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 other-div" id="addOtherNonWovenWeaving">
                                                <label class="font-500">Other Non Woven Yarn Type <span class="required"> *</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 add-nonwoven-features-field">
                                                <label class="font-500">Other Non Woven Feature <span
                                                        class="required">*</span></label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 add-End-field">
                                                <label class="font-500">Other Non Woven Use <span
                                                        class="required">*</span></label>
                                    ...
                                    <div class="additional-product-info machinery-info" style="display: none;">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 type-of-service">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 warranty-services">
                                    ...
                                    <div class="additional-product-info chemical-info" style="display: none;">
                                        ...
                                        <div class="chemical-info-inner">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6 additonial-info">
                                        ...
                                        <button type="button" class="red-btn add-btn">Add +</button>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="details" class="font-500">Additional Info <small class="font-500"> (Optional)</small></label>
                                            <textarea id="details" rows="5" class="form-control addi_info" maxlength = "1500" name="details"
                                ...
                                <div class="px-0 py-2 tab-pane fade trade-info-tab" id="tabCom" role="tabpanel"
                                ...
                                <div class="px-0 py-2 tab-pane fade payment-info-tab" id="tabInfo" role="tabpanel"
                                    ...
                                    <div class="form-row service-price">
                                        <div class="form-group col-md-6 unit_price_range">

                                            <div class="form-row">
                                                <div class="col-md-4">
                                                    <label for="unit_price_from" class="font-500 unit_price_range_label">Price Range <span class="required">*</span>
                                                    </label>
                                                    <label for="unit_price_from" class="font-500 service_charges_range_label">Service Charges Range <span class="required">*</span>
                                                    </label>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" id="unit_price_to" class="form-control"
                                                           name="unit_price_to" placeholder="e.g. 2000" style="margin-top: 24px;" required>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="unit_price_unit" class="font-500 unit_price_range_label">Per Unit <span
                                                            class="required">*</span></label>
                                                    <label for="unit_price_unit" class="font-500 service_charges_range_unit_label">Per Unit <span
                                                            class="required">*</span></label>
                                        ...
                                        <div class="form-group col-md-6 target_price_range">
                                            <div class="form-row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" id="target_price_to" class="form-control"
                                                           name="target_price_to" placeholder="e.g. 200" style="margin-top: 24px;" required>
                                                </div>
                                                <div class="col-md-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 product_lead_time">
                                        ...
                                        <div class="form-group col-md-6 product_delivery">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 services-container">
                                        ...
                                        <div class="form-group col-md-6 add-services-duration other-div">
...
@push('js')
    <script type="text/javascript">
        ...
        //     document.getElementsByName("product_service_name")[0].value = "";
        //     document.getElementsByName("subject")[0].value = "";
        //     document.getElementsByName("sub_sub_category")[0].value = "";
        //     document.getElementsByName("keyword1")[0].value = "";
        //     document.getElementsByName("keyword2")[0].value = "";
        //     document.getElementsByName("keyword3")[0].value = "";
        //     document.getElementsByName("add_sub_sub_category")[0].value = "";
        //     //document.getElementsByName("product_availability")[0].value = "";
        //     //$('input[name="product_availability"]').attr('checked', false);
        //     $('.product_availability').attr('checked', false);
        ...
        $(document).ready(function () {
            ...
            var validator = $("form[name='createProduct']").validate({
                ...
                messages: {
                    'product_service_types[]': {
                        required: "You must check at least 1 product & Service Type"
                    }
                },
