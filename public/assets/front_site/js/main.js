...
$(document).ready(function () {
    $(document).on('click', '.suppliers-nav .link', function() {
        $('.suppliers-nav .link').css('background', 'none');
        $(this).css('background', 'rgb(165, 44, 62)');
    });
    ...
    $(document).on('click', '.chat-dots-dropdown .quote-message', function () {
        ...
        if($(this).trigger('clicked')) {
            if(quoteMessage != "" && quoteMessage != " " && quoteImgLength == 0) {
                ...
                $('.reply-img-box').hide();
                if($(window).width() <= 575) {
                    $('.chat-messages').css('min-height', 'calc(100vh - 285px)');
                    $('.chat-messages').css('max-height', 'calc(100vh - 285px)');
                }
                ...
                $('.quote-box .reply-img-box .reply-img').attr('src', quoteImg);
                if($(window).width() <= 575) {
                    $('.chat-messages').css('min-height', 'calc(100vh - 360px)');
                    $('.chat-messages').css('max-height', 'calc(100vh - 360px)');
                }
                else if($(window).width() <= 991) {
